use ochre::{Path, Vec2, Mat2x2, Vertex, Color, Backend, GlBackend, Renderer, TILE_SIZE, ATLAS_SIZE};
...
fn main() {
    ...
    while running {
        ...
        renderer.fill(&path, Vec2::new(0.0, 0.0), Mat2x2::id(), Color::rgba(1.0, 1.0, 1.0, 1.0));
        renderer.submit(&mut backend, 800, 600);
