use crate::{Backend, Color, Mat2x2, Path, Vec2, Vertex, ATLAS_SIZE, TILE_SIZE};
...
impl Picture {
    ...
    pub fn submit(&mut self, backend: &mut dyn Backend, screen_width: u32, screen_height: u32) {
        backend.upload(0, 0, ATLAS_SIZE as u32, (self.next_tile_row as u32 + 1) * TILE_SIZE as u32, &self.tiles);
